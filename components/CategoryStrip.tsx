        ...
        {categories?.map((cat, i) => (
          <motion.div key={cat.slug} variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }}>
            <Link
              ...
              className="block py-3 px-4 rounded-lg border border-slate-200 bg-white hover:border-slate-300 hover:shadow-md hover:bg-slate-50/50 transition-all duration-200 group"
            >
