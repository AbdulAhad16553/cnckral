...
export const MACHINE_INSTALLATION_TITLE =
  "CNC KRAL Machine — Zameen Mein Lagane Ka Tareeqa";

export const MACHINE_INSTALLATION_INTRO =
  "Yeh guide aapko batati hai ke CNC KRAL router / laser machine ko floor par kaise anchor aur weld karna hai — base plates, expansion bolts, aur kamzor cement floor ke liye concrete pillars.";
...
export const MACHINE_INSTALLATION_FAQS: InstallationFaq[] = [
  {
    question: "CNC KRAL machine ko zameen mein lagane ke liye kitni base plates chahiye?",
    answer:
