...
export default function CareerApplicationForm() {
  ...
  return (
    <Card className="border-0 shadow-xl rounded-2xl overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-slate-50 to-blue-50/50 border-b border-slate-100 px-6 sm:px-8 py-6">
      ...
      <CardContent className="px-6 sm:px-8 py-7">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="designation"
              placeholder="e.g. CNC Operator, Technician, Engineer"
              className="border-slate-200 rounded-xl h-11 focus-visible:ring-[var(--primary-color)]/30"
          ...
          <div className="space-y-2">
            ...
            {!cvFile ? (
              <div
                className="border-2 border-dashed border-[var(--primary-color)]/25 rounded-xl p-8 sm:p-10 text-center hover:border-[var(--primary-color)]/45 hover:bg-blue-50/30 transition-all cursor-pointer group"
              ...
              <div className="rounded-xl border border-[var(--primary-color)]/20 bg-blue-50/30 overflow-hidden">
                {cvPreviewUrl && (
          ...
          <div className="flex items-start gap-3 p-4 rounded-xl border border-[var(--primary-color)]/15 bg-gradient-to-r from-blue-50/80 to-slate-50/40">
            <Checkbox
              id="public_consent"
